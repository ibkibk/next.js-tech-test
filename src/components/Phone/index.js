...
import logo from "../../../public/images/illustration-phones.svg"
...
const isDesktopOrLaptop = useMediaQuery({
    ...
    return (
        ...
        <div>
            {isDesktopOrLaptop?  <div className={style.container} >
            <div className={style.top}>
              <div className={style.content}>
                  ...
                  <p>  With reliability and speed in mind, <br />
                    ...
                    no <br /> matter where your readers are, keeping <br /> your site competitive.</p>
              </div>
            </div>
